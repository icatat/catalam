...
export const WEDDING_INFO = {
  [Location.ROMANIA]: {
    ...
    heroImageUrl: 'https://6khz2sa0mggxbsdm.public.blob.vercel-storage.com/photo_3.png',
    theme: 'Traditional Romanian Celebration 🇷🇴',
    name: 'Romania',
  },
  [Location.VIETNAM]: {
    ...
    heroImageUrl: 'https://6khz2sa0mggxbsdm.public.blob.vercel-storage.com/photo_0.png',
    theme: 'Vietnamese Wedding Ceremony 🇻🇳',
    name: 'Vietnam',
  }
} as const;
