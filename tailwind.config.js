...
module.exports = {
  ...
  theme: {
    extend: {
      fontFamily: {
        'serif': ['var(--font-thasadith)', 'serif'],
        'body': ['var(--font-thasadith)', 'sans-serif'],
        'sans': ['var(--font-thasadith)', 'sans-serif'],
      ...
      backgroundImage: {
        ...
        'gradient-wedding': 'linear-gradient(135deg, #fdf2f8 0%, #ffffff 50%, #fce7f3 100%)',
